...
#ifndef GOOGLE_PROTOBUF_INCLUDED_Packet_5f001_5fRoom_5fOffice_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_Packet_5f001_5fRoom_5fOffice_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_Packet_5f001_5fRoom_5fOffice_2eproto
...
struct TableStruct_Packet_5f001_5fRoom_5fOffice_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Packet_5f001_5fRoom_5fOffice_2eproto;
namespace Protocol {
...
class C_OFFICE_GET_CLIENT;
struct C_OFFICE_GET_CLIENTDefaultTypeInternal;
extern C_OFFICE_GET_CLIENTDefaultTypeInternal _C_OFFICE_GET_CLIENT_default_instance_;
...
class S_OFFICE_ADD_CLIENT;
struct S_OFFICE_ADD_CLIENTDefaultTypeInternal;
extern S_OFFICE_ADD_CLIENTDefaultTypeInternal _S_OFFICE_ADD_CLIENT_default_instance_;
class S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo;
struct S_OFFICE_ADD_CLIENT_MeetingModuleClientInfoDefaultTypeInternal;
extern S_OFFICE_ADD_CLIENT_MeetingModuleClientInfoDefaultTypeInternal _S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo_default_instance_;
...
class S_OFFICE_REMOVE_CLIENT;
struct S_OFFICE_REMOVE_CLIENTDefaultTypeInternal;
extern S_OFFICE_REMOVE_CLIENTDefaultTypeInternal _S_OFFICE_REMOVE_CLIENT_default_instance_;
...
template<> ::Protocol::C_OFFICE_GET_CLIENT* Arena::CreateMaybeMessage<::Protocol::C_OFFICE_GET_CLIENT>(Arena*);
...
template<> ::Protocol::S_OFFICE_ADD_CLIENT* Arena::CreateMaybeMessage<::Protocol::S_OFFICE_ADD_CLIENT>(Arena*);
template<> ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* Arena::CreateMaybeMessage<::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo>(Arena*);
...
template<> ::Protocol::S_OFFICE_REMOVE_CLIENT* Arena::CreateMaybeMessage<::Protocol::S_OFFICE_REMOVE_CLIENT>(Arena*);
...
class C_OFFICE_GET_WAITING_LIST final :
 ...
 private:
  ...
  friend struct ::TableStruct_Packet_5f001_5fRoom_5fOffice_2eproto;
};
// -------------------------------------------------------------------
...
class C_OFFICE_GET_CLIENT final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:Protocol.C_OFFICE_GET_CLIENT) */ {
 public:
  inline C_OFFICE_GET_CLIENT() : C_OFFICE_GET_CLIENT(nullptr) {}
  explicit PROTOBUF_CONSTEXPR C_OFFICE_GET_CLIENT(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  C_OFFICE_GET_CLIENT(const C_OFFICE_GET_CLIENT& from);
  C_OFFICE_GET_CLIENT(C_OFFICE_GET_CLIENT&& from) noexcept
    : C_OFFICE_GET_CLIENT() {
    *this = ::std::move(from);
  }

  inline C_OFFICE_GET_CLIENT& operator=(const C_OFFICE_GET_CLIENT& from) {
    CopyFrom(from);
    return *this;
  }
  inline C_OFFICE_GET_CLIENT& operator=(C_OFFICE_GET_CLIENT&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const C_OFFICE_GET_CLIENT& default_instance() {
    return *internal_default_instance();
  }
  static inline const C_OFFICE_GET_CLIENT* internal_default_instance() {
    return reinterpret_cast<const C_OFFICE_GET_CLIENT*>(
               &_C_OFFICE_GET_CLIENT_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    7;

  friend void swap(C_OFFICE_GET_CLIENT& a, C_OFFICE_GET_CLIENT& b) {
    a.Swap(&b);
  }
  inline void Swap(C_OFFICE_GET_CLIENT* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(C_OFFICE_GET_CLIENT* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  C_OFFICE_GET_CLIENT* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<C_OFFICE_GET_CLIENT>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const C_OFFICE_GET_CLIENT& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(const C_OFFICE_GET_CLIENT& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeImpl(*this, from);
  }
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.C_OFFICE_GET_CLIENT";
  }
  protected:
  explicit C_OFFICE_GET_CLIENT(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.C_OFFICE_GET_CLIENT)
 private:
  class _Internal;
...
class S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo) */ {
 public:
  inline S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo() : S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo(nullptr) {}
  ~S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo() override;
  explicit PROTOBUF_CONSTEXPR S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo(const S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& from);
  S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo(S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo&& from) noexcept
    : S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo() {
    *this = ::std::move(from);
  }

  inline S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& operator=(const S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& operator=(S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& default_instance() {
    return *internal_default_instance();
  }
  static inline const S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* internal_default_instance() {
    return reinterpret_cast<const S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo*>(
               &_S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& a, S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& from) {
    S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo";
  }
  protected:
  explicit S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo)
 private:
  class _Internal;
...
class S_OFFICE_ADD_CLIENT final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.S_OFFICE_ADD_CLIENT) */ {
 public:
  inline S_OFFICE_ADD_CLIENT() : S_OFFICE_ADD_CLIENT(nullptr) {}
  ~S_OFFICE_ADD_CLIENT() override;
  explicit PROTOBUF_CONSTEXPR S_OFFICE_ADD_CLIENT(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  S_OFFICE_ADD_CLIENT(const S_OFFICE_ADD_CLIENT& from);
  S_OFFICE_ADD_CLIENT(S_OFFICE_ADD_CLIENT&& from) noexcept
    : S_OFFICE_ADD_CLIENT() {
    *this = ::std::move(from);
  }

  inline S_OFFICE_ADD_CLIENT& operator=(const S_OFFICE_ADD_CLIENT& from) {
    CopyFrom(from);
    return *this;
  }
  inline S_OFFICE_ADD_CLIENT& operator=(S_OFFICE_ADD_CLIENT&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const S_OFFICE_ADD_CLIENT& default_instance() {
    return *internal_default_instance();
  }
  static inline const S_OFFICE_ADD_CLIENT* internal_default_instance() {
    return reinterpret_cast<const S_OFFICE_ADD_CLIENT*>(
               &_S_OFFICE_ADD_CLIENT_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    9;

  friend void swap(S_OFFICE_ADD_CLIENT& a, S_OFFICE_ADD_CLIENT& b) {
    a.Swap(&b);
  }
  inline void Swap(S_OFFICE_ADD_CLIENT* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(S_OFFICE_ADD_CLIENT* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  S_OFFICE_ADD_CLIENT* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<S_OFFICE_ADD_CLIENT>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const S_OFFICE_ADD_CLIENT& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const S_OFFICE_ADD_CLIENT& from) {
    S_OFFICE_ADD_CLIENT::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S_OFFICE_ADD_CLIENT* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.S_OFFICE_ADD_CLIENT";
  }
  protected:
  explicit S_OFFICE_ADD_CLIENT(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo MeetingModuleClientInfo;
  ...
  ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* mutable_clientinfos(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo >*
      mutable_clientinfos();
  private:
  const ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& _internal_clientinfos(int index) const;
  ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* _internal_add_clientinfos();
  public:
  const ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& clientinfos(int index) const;
  ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* add_clientinfos();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo >&
      clientinfos() const;

  // @@protoc_insertion_point(class_scope:Protocol.S_OFFICE_ADD_CLIENT)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo > clientinfos_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_Packet_5f001_5fRoom_5fOffice_2eproto;
...
class S_OFFICE_REMOVE_CLIENT final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.S_OFFICE_REMOVE_CLIENT) */ {
 public:
  inline S_OFFICE_REMOVE_CLIENT() : S_OFFICE_REMOVE_CLIENT(nullptr) {}
  ~S_OFFICE_REMOVE_CLIENT() override;
  explicit PROTOBUF_CONSTEXPR S_OFFICE_REMOVE_CLIENT(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  S_OFFICE_REMOVE_CLIENT(const S_OFFICE_REMOVE_CLIENT& from);
  S_OFFICE_REMOVE_CLIENT(S_OFFICE_REMOVE_CLIENT&& from) noexcept
    : S_OFFICE_REMOVE_CLIENT() {
    *this = ::std::move(from);
  }

  inline S_OFFICE_REMOVE_CLIENT& operator=(const S_OFFICE_REMOVE_CLIENT& from) {
    CopyFrom(from);
    return *this;
  }
  inline S_OFFICE_REMOVE_CLIENT& operator=(S_OFFICE_REMOVE_CLIENT&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const S_OFFICE_REMOVE_CLIENT& default_instance() {
    return *internal_default_instance();
  }
  static inline const S_OFFICE_REMOVE_CLIENT* internal_default_instance() {
    return reinterpret_cast<const S_OFFICE_REMOVE_CLIENT*>(
               &_S_OFFICE_REMOVE_CLIENT_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(S_OFFICE_REMOVE_CLIENT& a, S_OFFICE_REMOVE_CLIENT& b) {
    a.Swap(&b);
  }
  inline void Swap(S_OFFICE_REMOVE_CLIENT* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(S_OFFICE_REMOVE_CLIENT* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  S_OFFICE_REMOVE_CLIENT* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<S_OFFICE_REMOVE_CLIENT>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const S_OFFICE_REMOVE_CLIENT& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const S_OFFICE_REMOVE_CLIENT& from) {
    S_OFFICE_REMOVE_CLIENT::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(S_OFFICE_REMOVE_CLIENT* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.S_OFFICE_REMOVE_CLIENT";
  }
  protected:
  explicit S_OFFICE_REMOVE_CLIENT(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.S_OFFICE_REMOVE_CLIENT)
 private:
  class _Internal;
...
// string clientId = 1;
inline void S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::clear_clientid() {
  _impl_.clientid_.ClearToEmpty();
}
inline const std::string& S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::clientid() const {
  // @@protoc_insertion_point(field_get:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.clientId)
  return _internal_clientid();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::set_clientid(ArgT0&& arg0, ArgT... args) {
 
 _impl_.clientid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.clientId)
}
inline std::string* S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::mutable_clientid() {
  std::string* _s = _internal_mutable_clientid();
  // @@protoc_insertion_point(field_mutable:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.clientId)
  return _s;
}
inline const std::string& S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::_internal_clientid() const {
  return _impl_.clientid_.Get();
}
inline void S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::_internal_set_clientid(const std::string& value) {
  
  _impl_.clientid_.Set(value, GetArenaForAllocation());
}
inline std::string* S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::_internal_mutable_clientid() {
  
  return _impl_.clientid_.Mutable(GetArenaForAllocation());
}
inline std::string* S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::release_clientid() {
  // @@protoc_insertion_point(field_release:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.clientId)
  return _impl_.clientid_.Release();
}
inline void S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::set_allocated_clientid(std::string* clientid) {
  if (clientid != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.clientId)
}

// string nickname = 2;
inline void S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::clear_nickname() {
  _impl_.nickname_.ClearToEmpty();
}
inline const std::string& S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::nickname() const {
  // @@protoc_insertion_point(field_get:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.nickname)
  return _internal_nickname();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::set_nickname(ArgT0&& arg0, ArgT... args) {
 
 _impl_.nickname_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.nickname)
}
inline std::string* S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::mutable_nickname() {
  std::string* _s = _internal_mutable_nickname();
  // @@protoc_insertion_point(field_mutable:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.nickname)
  return _s;
}
inline const std::string& S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::_internal_nickname() const {
  return _impl_.nickname_.Get();
}
inline void S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::_internal_set_nickname(const std::string& value) {
  
  _impl_.nickname_.Set(value, GetArenaForAllocation());
}
inline std::string* S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::_internal_mutable_nickname() {
  
  return _impl_.nickname_.Mutable(GetArenaForAllocation());
}
inline std::string* S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::release_nickname() {
  // @@protoc_insertion_point(field_release:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.nickname)
  return _impl_.nickname_.Release();
}
inline void S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo::set_allocated_nickname(std::string* nickname) {
  if (nickname != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo.nickname)
}
...
// repeated .Protocol.S_OFFICE_ADD_CLIENT.MeetingModuleClientInfo clientInfos = 1;
inline int S_OFFICE_ADD_CLIENT::_internal_clientinfos_size() const {
  return _impl_.clientinfos_.size();
}
inline int S_OFFICE_ADD_CLIENT::clientinfos_size() const {
  return _internal_clientinfos_size();
}
inline void S_OFFICE_ADD_CLIENT::clear_clientinfos() {
  _impl_.clientinfos_.Clear();
}
inline ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* S_OFFICE_ADD_CLIENT::mutable_clientinfos(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.S_OFFICE_ADD_CLIENT.clientInfos)
  return _impl_.clientinfos_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo >*
S_OFFICE_ADD_CLIENT::mutable_clientinfos() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.S_OFFICE_ADD_CLIENT.clientInfos)
  return &_impl_.clientinfos_;
}
inline const ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& S_OFFICE_ADD_CLIENT::_internal_clientinfos(int index) const {
  return _impl_.clientinfos_.Get(index);
}
inline const ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo& S_OFFICE_ADD_CLIENT::clientinfos(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.S_OFFICE_ADD_CLIENT.clientInfos)
  return _internal_clientinfos(index);
}
inline ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* S_OFFICE_ADD_CLIENT::_internal_add_clientinfos() {
  return _impl_.clientinfos_.Add();
}
inline ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* S_OFFICE_ADD_CLIENT::add_clientinfos() {
  ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo* _add = _internal_add_clientinfos();
  // @@protoc_insertion_point(field_add:Protocol.S_OFFICE_ADD_CLIENT.clientInfos)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::S_OFFICE_ADD_CLIENT_MeetingModuleClientInfo >&
S_OFFICE_ADD_CLIENT::clientinfos() const {
  // @@protoc_insertion_point(field_list:Protocol.S_OFFICE_ADD_CLIENT.clientInfos)
  return _impl_.clientinfos_;
}
...
// repeated string clientIds = 1;
inline int S_OFFICE_REMOVE_CLIENT::_internal_clientids_size() const {
  return _impl_.clientids_.size();
}
inline int S_OFFICE_REMOVE_CLIENT::clientids_size() const {
  return _internal_clientids_size();
}
inline void S_OFFICE_REMOVE_CLIENT::clear_clientids() {
  _impl_.clientids_.Clear();
}
inline std::string* S_OFFICE_REMOVE_CLIENT::add_clientids() {
  std::string* _s = _internal_add_clientids();
  // @@protoc_insertion_point(field_add_mutable:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
  return _s;
}
inline const std::string& S_OFFICE_REMOVE_CLIENT::_internal_clientids(int index) const {
  return _impl_.clientids_.Get(index);
}
inline const std::string& S_OFFICE_REMOVE_CLIENT::clientids(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
  return _internal_clientids(index);
}
inline std::string* S_OFFICE_REMOVE_CLIENT::mutable_clientids(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
  return _impl_.clientids_.Mutable(index);
}
inline void S_OFFICE_REMOVE_CLIENT::set_clientids(int index, const std::string& value) {
  _impl_.clientids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
}
inline void S_OFFICE_REMOVE_CLIENT::set_clientids(int index, std::string&& value) {
  _impl_.clientids_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
}
inline void S_OFFICE_REMOVE_CLIENT::set_clientids(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.clientids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
}
inline void S_OFFICE_REMOVE_CLIENT::set_clientids(int index, const char* value, size_t size) {
  _impl_.clientids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
}
inline std::string* S_OFFICE_REMOVE_CLIENT::_internal_add_clientids() {
  return _impl_.clientids_.Add();
}
inline void S_OFFICE_REMOVE_CLIENT::add_clientids(const std::string& value) {
  _impl_.clientids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
}
inline void S_OFFICE_REMOVE_CLIENT::add_clientids(std::string&& value) {
  _impl_.clientids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
}
inline void S_OFFICE_REMOVE_CLIENT::add_clientids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.clientids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
}
inline void S_OFFICE_REMOVE_CLIENT::add_clientids(const char* value, size_t size) {
  _impl_.clientids_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
S_OFFICE_REMOVE_CLIENT::clientids() const {
  // @@protoc_insertion_point(field_list:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
  return _impl_.clientids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
S_OFFICE_REMOVE_CLIENT::mutable_clientids() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.S_OFFICE_REMOVE_CLIENT.clientIds)
  return &_impl_.clientids_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_Packet_5f001_5fRoom_5fOffice_2eproto
