...
bool Handle_C_WILDCARD_MAP(shared_ptr<GameSession>& session, Protocol::C_WILDCARD_MAP& pkt)
{
	...
	session->owner->enteredRoom->Handle_C_WILDCARD_MAP(session->owner, pkt);
...
bool Handle_C_BASE_REMOVE_OBJECT(shared_ptr<GameSession>& session, Protocol::C_BASE_REMOVE_OBJECT& pkt)
{
	...
	session->owner->enteredRoom->Handle_C_BASE_REMOVE_OBJECT(session->owner, pkt);
...
bool Handle_C_OFFICE_GET_PERMISSION_ALL(shared_ptr<GameSession>& session, Protocol::C_OFFICE_GET_PERMISSION_ALL& pkt)
{
	...
	session->owner->enteredRoom->Handle_C_OFFICE_GET_PERMISSION_ALL(session->owner, pkt);
...
bool Handle_C_OFFICE_GET_VIDEO_STREAM(shared_ptr<GameSession>& session, Protocol::C_OFFICE_GET_VIDEO_STREAM& pkt)
{
	...
	session->owner->enteredRoom->Handle_C_OFFICE_GET_VIDEO_STREAM(session->owner, pkt);
