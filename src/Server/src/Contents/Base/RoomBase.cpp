...
{
	{
		...
		{
			std::cerr << "From RoomBase, SOCI Error: " << e.what() << std::endl;
		}
		catch (const std::exception& e) {
			std::cerr << "From RoomBase, Standard Exception: " << e.what() << std::endl;
		}
		catch (...) {
			std::cerr << "From RoomBase, Unknown Exception Caught" << std::endl;
		}
	}
}
